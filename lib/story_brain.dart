...
class StoryBrain {
  ...
  void nextStory(int choice) {
    bool isChoice1 = choice == 1;
    bool isChoice2 = choice == 2;

    if (_storyNumber == 0 && isChoice1) {
      _storyNumber = 2;
    } else if (_storyNumber == 0 && isChoice2) {
      _storyNumber = 1;
    } else if (_storyNumber == 1 && isChoice1) {
      _storyNumber = 2;
    } else if (_storyNumber == 1 && isChoice2) {
      _storyNumber = 3;
    } else if (_storyNumber == 2 && isChoice1) {
      _storyNumber = 5;
    } else if (_storyNumber == 2 && isChoice2) {
      _storyNumber = 4;
    } else {
      restart();
    }
